...
uint64_t xitongshijianms = 0,ledfanzhuanms;
extern int64_t jicunqi[256];
...
int main(void)
{
  ...
  //jiasuleibiaojisuan(jicunqi[0],jicunqi[1],jicunqi[3],31004);//先计算一遍加速表

 // dianji[0].zuidasudu = s2b(jicunqi[0],jicunqi[2]);//设置�????大�?�度
  //uint64_t aa = 96000;
